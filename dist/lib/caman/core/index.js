    ...
    value: function parseArguments(args) {
      ...
      if (args.length === 4) {
        return function () {
          ...
          for (var _i = 0, _Object$keys = Object.keys(args[4] || {}); _i < _Object$keys.length; _i++) {
...
var _temp = function () {
  ...
  __REACT_HOT_LOADER__.register(Caman, "Caman", "/home/user-js/work/photoEditor/projects/react/lib/caman/core/index.js");

  __REACT_HOT_LOADER__.register(_default, "default", "/home/user-js/work/photoEditor/projects/react/lib/caman/core/index.js");
}();
